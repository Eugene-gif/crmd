  ...
  setup() {
    ...
    async function updateDesigner() {
      ...
      try {
        ...
        checkTg()
        checkInst()
        await designerApi.updateDesigner(formData.value).then(resp => {
          formData.value = resp
    ...
    async function getInfoDesigner() {
      try {
        await designerApi.getInfoDesigner().then(resp => {
          formData.value = resp
          if (formData.value.public_email == null) formData.value.public_email = ''
          console.log(formData.value.public_email)
