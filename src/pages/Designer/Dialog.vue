    ...
    <q-form @submit="submit">
      ...
      <div class="dialog-section">
        ...
        <q-card-section class="form-section">
          ...
          <q-input v-model="formData.name" class="my-input bg-grey-3" placeholder="Введите название" :rules="[ val => val && val.length > 0 || '']" />
        </q-card-section>
        ...
        <q-card-section 
          ...
          :class="[
            {'form-section-row-offer-enter': formData.service_term.length && formData.service_price.length || formData.unit_price.length && formData.unit_term.length}
          ]"
        >
          <div class="close-form rotate" @click="modalFalse()">
            ...
            <div class="form-col-6-row q-pl-none items-start">
              ...
              <div class="cell-form">
                ...
                <q-input 
                  ...
                  :disable="formData.unit_term !== '' || formData.unit_price !== ''"
                />
              </div>
              <div class="cell-form">
                <label class="lable-title" style="display: flex;">
            ...
            <div class="form-col-6-row q-pl-none items-start">
              ...
              <div class="cell-form">
                ...
                <q-input 
                  ...
                  class="my-input bg-grey-3 q-field__no-append" 
                  placeholder="Стоимость" 
                  :disable="formData.service_term !== '' || formData.service_price !== ''"
                />
              </div>
              <div class="cell-form">
                <label class="lable-title" style="display: flex;">
...
export default ({
  ...
  setup (props, { emit }) {
    ...
    async function addService() {
      ...
      for (const prop in formData.value) {
        if (prop === 'name') {
          ...
          if (formData.value[prop] != '') formDataNumber[prop] = isNaN(formData.value[prop]) ? '' : Number(formData.value[prop])
        }
      }
    ...
    function submit() {
      if (
        (formData.value.service_term != '' && formData.value.service_price != '') ||
        (formData.value.unit_term != '' && formData.value.unit_price != '') 
      ) {
        addService()
      } else {
        $q.notify({
          color: 'negative',
          message: 'Внесите данные за услугу целиком, либо за квадратный метр'
        })
      }
    }
