...
export default ({
  ...
  setup (props) {
    ...
    return {
      ...
      select2: ref(
        {
          label: props.editValue.status.name || 'Не согласовано',
      ...
      text: ref(''),
      text2: ref(props.editValue.name.title || ''),
      link: ref(props.editValue.link || ''),
      edinic: ref(props.editValue.price || ''),
      stavka: ref(props.editValue.procent || ''),
      show: ref(false),
      text3: ref(props.editValue.metrics || ''),

      textarea: ref(props.editValue.desc || ''),
